...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="Noodles&canned.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Noodles</a>
				</th>
	...
	<div style="padding: 60px 150px; font-size: 20px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
