		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><a href="DeliveryRecords.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Delivery Records</a></th>
					<?php 
						if($utype_db == 'admin'){
  											...
  											<h5>Item:</h5>
												...
												<select name="item" required="required" style=" font-size: 20px;
														font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #169E8F;color: #169E8F;margin-left: 195px;width: 300px;background-color: transparent;" class="">
																<option selected value="noodles">Noodles</option>
																<option value="seasoning">Seasonings</option>
																<option value="drink">Drinks</option>
																<option value="soap">Soap</option>
																<option value="sweet">Chocolates</option>
																<option value="snack">Snacks</option>
																<option value="shampoo">Shampoo</option>
																<option value="hiegene">Hygiene</option>
												</select>
												</td>
											</div></br>
