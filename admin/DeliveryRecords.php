	...
	<body class="home-welcome-text" style="background-image: url(../image/homebackgrndimg2.png);">
		...
		<div class="categolis">
			<table>
				...
				<th><a href="DeliveryRecords.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Delivery Records</a></th>
					<?php 
						if($utype_db == 'admin'){
