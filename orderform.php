...
if (!isset($_SESSION['user_login'])) {
	...
	$result = mysqli_query($con, "SELECT * FROM users WHERE id='$user'");
		$get_user_email = mysqli_fetch_assoc($result);
			...
			$ulast_db=$get_user_email['last_name'];
...
<body style="background-image: url(image/homebackgrndimg1.jpg);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="OurProducts/NoodlesCanned.php" style="text-decoration: none;color:#040403 ;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Noodles</a>
				</th>
				...
				<th><a href="OurProducts/Drinks.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Soft Drinks</a></th>
				...
				<th><a href="OurProducts/Sweets.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Chocolate Bars</a></th>
				<th><a href="OurProducts/Soap&Detergent.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Soap</a></th>
							...
							<form action="" method="POST" class="registration">
								...
								<h3 style="color:red;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
									...
									Types of Delivery <br>
									 ...
									 <input name="Delivery" required="required" value="Express Delivery +Rs.50 upon cash on delivery" type="radio"  placeholder="Mode Of Payment"> Express Delivery </br>
		...
		<div style="float: left; font-size: 23px;">
			<div>
				<?php
					echo '
						<ul style="float: left;">
							<li style="float: left; padding: 50px 25px 25px 25px;">
